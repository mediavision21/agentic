...
| `dim_service`           | maps `service_id` to `canonical_name` + boolean flags (denormalized onto `macro.nordic`): `is_streaming_service`, `is_social_video`, `is_avod`, `is_fast`, `is_public_service` |
